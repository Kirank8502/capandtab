...
--
-- Host: localhost:3306
-- Generation Time: Sep 23, 2024 at 03:37 AM
...
--
-- Table structure for table `dd_address`
--
...
--
-- Table structure for table `dd_address_format`
--

CREATE TABLE `dd_address_format` (
...
--
-- Dumping data for table `dd_address_format`
--

INSERT INTO `dd_address_format` (`address_format_id`, `name`, `address_format`) VALUES
(1, 'Address Format', '{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}');

-- --------------------------------------------------------

--
-- Table structure for table `dd_antispam`
--

CREATE TABLE `dd_antispam` (
...
--
-- Table structure for table `dd_api`
--
...
--
-- Dumping data for table `dd_api`
--

INSERT INTO `dd_api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '2024-09-06 22:06:35', '2024-09-06 22:06:35');

-- --------------------------------------------------------

--
-- Table structure for table `dd_api_ip`
--

CREATE TABLE `dd_api_ip` (
...
--
-- Table structure for table `dd_api_session`
--

CREATE TABLE `dd_api_session` (
...
--
-- Table structure for table `dd_article`
--
...
--
-- Table structure for table `dd_article_comment`
--

CREATE TABLE `dd_article_comment` (
...
--
-- Table structure for table `dd_article_description`
--

CREATE TABLE `dd_article_description` (
  `article_id` int NOT NULL,
...
--
-- Table structure for table `dd_article_to_layout`
--

CREATE TABLE `dd_article_to_layout` (
  `article_id` int NOT NULL,
...
--
-- Table structure for table `dd_article_to_store`
--

CREATE TABLE `dd_article_to_store` (
  `article_id` int NOT NULL,
...
--
-- Table structure for table `dd_assembler`
--
...
--
-- Dumping data for table `dd_assembler`
--

INSERT INTO `dd_assembler` (`assembler_id`, `name`, `status`) VALUES
(1, 'testtt', 1),
(13, 'Abcc', 0);
...
--
-- Dumping data for table `dd_attribute`
--

INSERT INTO `dd_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Table structure for table `dd_attribute_description`
--

CREATE TABLE `dd_attribute_description` (
  `attribute_id` int NOT NULL,
  `language_id` int NOT NULL,
...
--
-- Dumping data for table `dd_attribute_description`
--

INSERT INTO `dd_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(3, 1, 'Clockspeed'),
(4, 1, 'test 1'),
...
--
-- Table structure for table `dd_attribute_group`
--

CREATE TABLE `dd_attribute_group` (
  `attribute_group_id` int NOT NULL,
  `sort_order` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `dd_attribute_group`
--

INSERT INTO `dd_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Table structure for table `dd_attribute_group_description`
--

CREATE TABLE `dd_attribute_group_description` (
  `attribute_group_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `dd_attribute_group_description`
--

INSERT INTO `dd_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor');
...
--
-- Table structure for table `dd_banner`
--
...
--
-- Dumping data for table `dd_banner`
--

INSERT INTO `dd_banner` (`banner_id`, `name`, `status`) VALUES
(6, 'HP Products', 1),
...
--
-- Table structure for table `dd_banner_image`
--

CREATE TABLE `dd_banner_image` (
...
--
-- Dumping data for table `dd_banner_image`
--

INSERT INTO `dd_banner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
...
INSERT INTO `dd_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
(59, '', 33, 1, 1, 0, 1, '2024-09-07 17:50:58', '2024-09-07 17:50:58');

-- --------------------------------------------------------

--
-- Table structure for table `dd_category_description`
--

CREATE TABLE `dd_category_description` (
  `category_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `description` text COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `dd_category_description`
--

INSERT INTO `dd_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
(59, 1, 'testt', '&lt;p&gt;dhjjhsd&lt;/p&gt;', 'ashjjas', 'kjdbsvks', 'dsbks');

-- --------------------------------------------------------

--
-- Table structure for table `dd_category_filter`
--

CREATE TABLE `dd_category_filter` (
  `category_id` int NOT NULL,
...
--
-- Table structure for table `dd_category_path`
--

CREATE TABLE `dd_category_path` (
  `category_id` int NOT NULL,
...
--
-- Dumping data for table `dd_category_path`
--

INSERT INTO `dd_category_path` (`category_id`, `path_id`, `level`) VALUES
(17, 17, 0),
(18, 18, 0),
(20, 20, 0),
(24, 24, 0),
...
--
-- Table structure for table `dd_category_to_layout`
--

CREATE TABLE `dd_category_to_layout` (
  `category_id` int NOT NULL,
  `store_id` int NOT NULL,
  `layout_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `dd_category_to_layout`
--

INSERT INTO `dd_category_to_layout` (`category_id`, `store_id`, `layout_id`) VALUES
(59, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `dd_category_to_store`
--

CREATE TABLE `dd_category_to_store` (
  `category_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `dd_category_to_store`
--

INSERT INTO `dd_category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
INSERT INTO `dd_client` (`client_id`, `name`, `status`) VALUES
(1, 'Clientttt', 1);

-- --------------------------------------------------------

--
-- Table structure for table `dd_colour`
--
...
--
-- Dumping data for table `dd_colour`
--

INSERT INTO `dd_colour` (`colour_id`, `name`, `qty`, `status`) VALUES
(1, 'Yellow', 1, 1);
...
INSERT INTO `dd_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format_id`, `postcode_required`, `status`) VALUES
...
--
-- Table structure for table `dd_coupon`
--
...
--
-- Dumping data for table `dd_coupon`
--

INSERT INTO `dd_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `dd_coupon_category`
--

CREATE TABLE `dd_coupon_category` (
  `coupon_id` int NOT NULL,
  `category_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_coupon_history`
--

CREATE TABLE `dd_coupon_history` (
...
--
-- Table structure for table `dd_coupon_product`
--

CREATE TABLE `dd_coupon_product` (
...
--
-- Table structure for table `dd_cron`
--

CREATE TABLE `dd_cron` (
...
--
-- Dumping data for table `dd_cron`
--

INSERT INTO `dd_cron` (`cron_id`, `code`, `description`, `cycle`, `action`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `dd_currency`
--
...
--
-- Dumping data for table `dd_currency`
--

INSERT INTO `dd_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
...
--
-- Table structure for table `dd_customer`
--
...
--
-- Table structure for table `dd_customer_activity`
--

CREATE TABLE `dd_customer_activity` (
...
--
-- Table structure for table `dd_customer_affiliate`
--

CREATE TABLE `dd_customer_affiliate` (
  `customer_id` int NOT NULL,
  `company` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Table structure for table `dd_customer_affiliate_report`
--

CREATE TABLE `dd_customer_affiliate_report` (
...
--
-- Table structure for table `dd_customer_approval`
--

CREATE TABLE `dd_customer_approval` (
...
--
-- Table structure for table `dd_customer_group`
--

CREATE TABLE `dd_customer_group` (
  `customer_group_id` int NOT NULL,
...
--
-- Dumping data for table `dd_customer_group`
--

INSERT INTO `dd_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `dd_customer_group_description`
--

CREATE TABLE `dd_customer_group_description` (
  `customer_group_id` int NOT NULL,
  `language_id` int NOT NULL,
...
--
-- Dumping data for table `dd_customer_group_description`
--

INSERT INTO `dd_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1, 1, 'Default', 'test');

-- --------------------------------------------------------

--
-- Table structure for table `dd_customer_history`
--

CREATE TABLE `dd_customer_history` (
...
--
-- Table structure for table `dd_customer_ip`
--

CREATE TABLE `dd_customer_ip` (
...
--
-- Table structure for table `dd_customer_login`
--

CREATE TABLE `dd_customer_login` (
...
--
-- Table structure for table `dd_customer_online`
--

CREATE TABLE `dd_customer_online` (
  `ip` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
  `customer_id` int NOT NULL,
...
--
-- Table structure for table `dd_customer_reward`
--

CREATE TABLE `dd_customer_reward` (
...
--
-- Table structure for table `dd_customer_search`
--

CREATE TABLE `dd_customer_search` (
...
--
-- Table structure for table `dd_customer_transaction`
--

CREATE TABLE `dd_customer_transaction` (
...
--
-- Table structure for table `dd_customer_wishlist`
--

CREATE TABLE `dd_customer_wishlist` (
  `customer_id` int NOT NULL,
  `product_id` int NOT NULL,
  `date_added` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_custom_field`
--

CREATE TABLE `dd_custom_field` (
...
--
-- Dumping data for table `dd_custom_field`
--

INSERT INTO `dd_custom_field` (`custom_field_id`, `type`, `value`, `validation`, `location`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `dd_custom_field_customer_group`
--

CREATE TABLE `dd_custom_field_customer_group` (
  `custom_field_id` int NOT NULL,
  `customer_group_id` int NOT NULL,
...
--
-- Dumping data for table `dd_custom_field_customer_group`
--

INSERT INTO `dd_custom_field_customer_group` (`custom_field_id`, `customer_group_id`, `required`) VALUES
(1, 1, 1),
(2, 1, 1),
(3, 1, 1),
(4, 1, 1),
...
--
-- Table structure for table `dd_custom_field_description`
--

CREATE TABLE `dd_custom_field_description` (
  `custom_field_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(128) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `dd_custom_field_description`
--

INSERT INTO `dd_custom_field_description` (`custom_field_id`, `language_id`, `name`) VALUES
(1, 1, 'Select'),
(2, 1, 'Radio'),
(3, 1, 'Checkbox'),
(4, 1, 'Text'),
...
--
-- Table structure for table `dd_custom_field_value`
--

CREATE TABLE `dd_custom_field_value` (
...
--
-- Dumping data for table `dd_custom_field_value`
--

INSERT INTO `dd_custom_field_value` (`custom_field_value_id`, `custom_field_id`, `sort_order`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 1),
...
--
-- Table structure for table `dd_custom_field_value_description`
--

CREATE TABLE `dd_custom_field_value_description` (
  `custom_field_value_id` int NOT NULL,
  `language_id` int NOT NULL,
  `custom_field_id` int NOT NULL,
  `name` varchar(128) COLLATE utf8mb4_general_ci NOT NULL
...
--
-- Dumping data for table `dd_custom_field_value_description`
--

INSERT INTO `dd_custom_field_value_description` (`custom_field_value_id`, `language_id`, `custom_field_id`, `name`) VALUES
(1, 1, 1, 'Test 1'),
(2, 1, 1, 'test 2'),
(3, 1, 1, 'Test 3'),
(4, 1, 2, 'Test 1'),
...
--
-- Table structure for table `dd_download`
--

CREATE TABLE `dd_download` (
...
--
-- Table structure for table `dd_download_description`
--

CREATE TABLE `dd_download_description` (
  `download_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_download_report`
--

CREATE TABLE `dd_download_report` (
...
--
-- Table structure for table `dd_event`
--

CREATE TABLE `dd_event` (
...
--
-- Dumping data for table `dd_event`
--

INSERT INTO `dd_event` (`event_id`, `code`, `description`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `dd_extension`
--

CREATE TABLE `dd_extension` (
...
--
-- Dumping data for table `dd_extension`
--

INSERT INTO `dd_extension` (`extension_id`, `extension`, `type`, `code`) VALUES
...
--
-- Table structure for table `dd_extension_install`
--

CREATE TABLE `dd_extension_install` (
...
--
-- Dumping data for table `dd_extension_install`
--

INSERT INTO `dd_extension_install` (`extension_install_id`, `extension_id`, `extension_download_id`, `name`, `code`, `version`, `author`, `link`, `status`, `date_added`) VALUES
(1, 0, 0, 'OpenCart Default Extensions', 'opencart', '1.0', 'OpenCart Ltd', 'http://www.opencart.com', 1, '2020-08-29 15:35:39');

-- --------------------------------------------------------

--
-- Table structure for table `dd_extension_path`
--

CREATE TABLE `dd_extension_path` (
...
--
-- Dumping data for table `dd_extension_path`
--

INSERT INTO `dd_extension_path` (`extension_path_id`, `extension_install_id`, `path`) VALUES
(1, 1, 'opencart'),
(2, 1, 'opencart/admin'),
...
--
-- Table structure for table `dd_filter`
--

CREATE TABLE `dd_filter` (
  `filter_id` int NOT NULL,
...
--
-- Table structure for table `dd_filter_description`
--

CREATE TABLE `dd_filter_description` (
  `filter_id` int NOT NULL,
  `language_id` int NOT NULL,
  `filter_group_id` int NOT NULL,
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL
...
--
-- Table structure for table `dd_filter_group`
--

CREATE TABLE `dd_filter_group` (
  `filter_group_id` int NOT NULL,
  `sort_order` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_filter_group_description`
--

CREATE TABLE `dd_filter_group_description` (
  `filter_group_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_gdpr`
--

CREATE TABLE `dd_gdpr` (
...
--
-- Table structure for table `dd_geo_zone`
--

CREATE TABLE `dd_geo_zone` (
...
--
-- Dumping data for table `dd_geo_zone`
--

INSERT INTO `dd_geo_zone` (`geo_zone_id`, `name`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `dd_information`
--

CREATE TABLE `dd_information` (
...
--
-- Dumping data for table `dd_information`
--

INSERT INTO `dd_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(1, 1, 3, 1),
(2, 1, 1, 1),
(3, 1, 4, 1),
(4, 1, 2, 1);
...
--
-- Table structure for table `dd_information_description`
--

CREATE TABLE `dd_information_description` (
  `information_id` int NOT NULL,
  `language_id` int NOT NULL,
  `title` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `dd_information_description`
--

INSERT INTO `dd_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(1, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n', 'About Us', '', ''),
...
--
-- Table structure for table `dd_information_to_layout`
--

CREATE TABLE `dd_information_to_layout` (
  `information_id` int NOT NULL,
  `store_id` int NOT NULL,
  `layout_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_information_to_store`
--

CREATE TABLE `dd_information_to_store` (
  `information_id` int NOT NULL,
  `store_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `dd_information_to_store`
--

INSERT INTO `dd_information_to_store` (`information_id`, `store_id`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0);
...
INSERT INTO `dd_language` (`language_id`, `name`, `code`, `locale`, `extension`, `sort_order`, `status`) VALUES
...
--
-- Dumping data for table `dd_layout`
--

INSERT INTO `dd_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
--
-- Table structure for table `dd_layout_module`
--

CREATE TABLE `dd_layout_module` (
...
--
-- Dumping data for table `dd_layout_module`
--

INSERT INTO `dd_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
...
--
-- Table structure for table `dd_layout_route`
--

CREATE TABLE `dd_layout_route` (
...
--
-- Dumping data for table `dd_layout_route`
--

INSERT INTO `dd_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(1, 6, 0, 'account/%'),
...
--
-- Table structure for table `dd_length_class`
--

CREATE TABLE `dd_length_class` (
  `length_class_id` int NOT NULL,
  `value` decimal(15,8) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `dd_length_class`
--

INSERT INTO `dd_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
--
-- Table structure for table `dd_length_class_description`
--

CREATE TABLE `dd_length_class_description` (
  `length_class_id` int NOT NULL,
  `language_id` int NOT NULL,
  `title` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `dd_length_class_description`
--

INSERT INTO `dd_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
...
--
-- Table structure for table `dd_manufacturer`
--

CREATE TABLE `dd_manufacturer` (
...
--
-- Dumping data for table `dd_manufacturer`
--

INSERT INTO `dd_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `dd_manufacturer_to_layout`
--

CREATE TABLE `dd_manufacturer_to_layout` (
  `manufacturer_id` int NOT NULL,
  `store_id` int NOT NULL,
  `layout_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_manufacturer_to_store`
--

CREATE TABLE `dd_manufacturer_to_store` (
  `manufacturer_id` int NOT NULL,
  `store_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `dd_manufacturer_to_store`
--

INSERT INTO `dd_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Table structure for table `dd_marketing`
--

CREATE TABLE `dd_marketing` (
...
--
-- Table structure for table `dd_marketing_report`
--

CREATE TABLE `dd_marketing_report` (
...
--
-- Table structure for table `dd_module`
--
...
--
-- Dumping data for table `dd_module`
--

INSERT INTO `dd_module` (`module_id`, `name`, `code`, `setting`) VALUES
...
--
-- Table structure for table `dd_notification`
--

CREATE TABLE `dd_notification` (
...
--
-- Table structure for table `dd_option`
--

CREATE TABLE `dd_option` (
...
--
-- Dumping data for table `dd_option`
--

INSERT INTO `dd_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 1),
(2, 'checkbox', 2),
(4, 'text', 3),
(5, 'select', 4),
...
--
-- Table structure for table `dd_option_description`
--

CREATE TABLE `dd_option_description` (
  `option_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(128) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `dd_option_description`
--

INSERT INTO `dd_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(5, 1, 'Select'),
...
--
-- Table structure for table `dd_option_value`
--

CREATE TABLE `dd_option_value` (
...
--
-- Dumping data for table `dd_option_value`
--

INSERT INTO `dd_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(23, 2, '', 1),
(24, 2, '', 2),
(31, 1, '', 2),
(32, 1, '', 1),
...
--
-- Table structure for table `dd_option_value_description`
--

CREATE TABLE `dd_option_value_description` (
  `option_value_id` int NOT NULL,
  `language_id` int NOT NULL,
  `option_id` int NOT NULL,
  `name` varchar(128) COLLATE utf8mb4_general_ci NOT NULL
...
--
-- Dumping data for table `dd_option_value_description`
--

INSERT INTO `dd_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(23, 1, 2, 'Checkbox 1'),
(24, 1, 2, 'Checkbox 2'),
(31, 1, 1, 'Medium'),
(32, 1, 1, 'Small'),
...
--
-- Table structure for table `dd_orders`
--
...
--
-- Table structure for table `dd_order_history`
--

CREATE TABLE `dd_order_history` (
...
--
-- Table structure for table `dd_order_option`
--

CREATE TABLE `dd_order_option` (
...
--
-- Table structure for table `dd_order_product`
--

CREATE TABLE `dd_order_product` (
  `order_product_id` int NOT NULL,
  `order_id` int NOT NULL,
  `product_id` int NOT NULL,
...
--
-- Table structure for table `dd_order_status`
--

CREATE TABLE `dd_order_status` (
  `order_status_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(32) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `dd_order_status`
--

INSERT INTO `dd_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(5, 1, 'Complete'),
...
--
-- Table structure for table `dd_order_subscription`
--

CREATE TABLE `dd_order_subscription` (
...
--
-- Table structure for table `dd_order_total`
--

CREATE TABLE `dd_order_total` (
...
--
-- Table structure for table `dd_order_voucher`
--

CREATE TABLE `dd_order_voucher` (
...
--
-- Table structure for table `dd_powder`
--
...
--
-- Dumping data for table `dd_powder`
--

INSERT INTO `dd_powder` (`powder_id`, `name`, `qty`, `status`) VALUES
(1, 'testt', 4, 1);
...
INSERT INTO `dd_product` (`product_id`, `name`, `status`) VALUES
(1, 'Tap', 1);

-- --------------------------------------------------------

--
-- Table structure for table `dd_product_1`
--

CREATE TABLE `dd_product_1` (
  `product_id` int NOT NULL,
...
--
-- Table structure for table `dd_product_attribute`
--

CREATE TABLE `dd_product_attribute` (
  `product_id` int NOT NULL,
  `attribute_id` int NOT NULL,
  `language_id` int NOT NULL,
  `text` text COLLATE utf8mb4_general_ci NOT NULL
...
--
-- Dumping data for table `dd_product_attribute`
--

INSERT INTO `dd_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(42, 3, 1, '100mhz'),
(43, 2, 1, '1'),
(43, 4, 1, '8gb'),
(47, 2, 1, '4'),
...
--
-- Table structure for table `dd_product_description`
--

CREATE TABLE `dd_product_description` (
  `product_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `description` text COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `dd_product_description`
--

INSERT INTO `dd_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Table structure for table `dd_product_discount`
--

CREATE TABLE `dd_product_discount` (
...
--
-- Dumping data for table `dd_product_discount`
--

INSERT INTO `dd_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `dd_product_filter`
--

CREATE TABLE `dd_product_filter` (
  `product_id` int NOT NULL,
  `filter_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_product_image`
--

CREATE TABLE `dd_product_image` (
...
--
-- Dumping data for table `dd_product_image`
--

INSERT INTO `dd_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `dd_product_option`
--

CREATE TABLE `dd_product_option` (
  `product_option_id` int NOT NULL,
  `product_id` int NOT NULL,
  `option_id` int NOT NULL,
  `value` text COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `dd_product_option`
--

INSERT INTO `dd_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(208, 42, 4, 'test', 1),
(209, 42, 6, '', 1),
(217, 42, 5, '', 1),
(218, 42, 1, '', 1),
...
--
-- Table structure for table `dd_product_option_value`
--

CREATE TABLE `dd_product_option_value` (
...
--
-- Dumping data for table `dd_product_option_value`
--

INSERT INTO `dd_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Table structure for table `dd_product_related`
--

CREATE TABLE `dd_product_related` (
  `product_id` int NOT NULL,
  `related_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `dd_product_related`
--

INSERT INTO `dd_product_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- Table structure for table `dd_product_report`
--

CREATE TABLE `dd_product_report` (
...
--
-- Table structure for table `dd_product_reward`
--

CREATE TABLE `dd_product_reward` (
...
--
-- Dumping data for table `dd_product_reward`
--

INSERT INTO `dd_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(329, 43, 1, 600),
(331, 44, 1, 700),
(333, 45, 1, 800),
(335, 40, 1, 0),
...
--
-- Table structure for table `dd_product_special`
--

CREATE TABLE `dd_product_special` (
...
--
-- Dumping data for table `dd_product_special`
--

INSERT INTO `dd_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `dd_product_subscription`
--

CREATE TABLE `dd_product_subscription` (
  `product_id` int NOT NULL,
  `subscription_plan_id` int NOT NULL,
  `customer_group_id` int NOT NULL,
  `trial_price` decimal(10,4) NOT NULL,
...
--
-- Table structure for table `dd_product_to_category`
--

CREATE TABLE `dd_product_to_category` (
  `product_id` int NOT NULL,
  `category_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `dd_product_to_category`
--

INSERT INTO `dd_product_to_category` (`product_id`, `category_id`) VALUES
(43, 18),
(44, 18),
(45, 18),
(46, 18),
...
--
-- Table structure for table `dd_product_to_download`
--

CREATE TABLE `dd_product_to_download` (
  `product_id` int NOT NULL,
  `download_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_product_to_layout`
--

CREATE TABLE `dd_product_to_layout` (
  `product_id` int NOT NULL,
  `store_id` int NOT NULL,
  `layout_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_product_to_store`
--

CREATE TABLE `dd_product_to_store` (
  `product_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `dd_product_to_store`
--

INSERT INTO `dd_product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
--
-- Table structure for table `dd_product_viewed`
--

CREATE TABLE `dd_product_viewed` (
  `product_id` int NOT NULL,
  `viewed` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_return`
--

CREATE TABLE `dd_return` (
...
--
-- Table structure for table `dd_return_action`
--

CREATE TABLE `dd_return_action` (
  `return_action_id` int NOT NULL,
...
--
-- Dumping data for table `dd_return_action`
--

INSERT INTO `dd_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, 1, 'Refunded'),
(2, 1, 'Credit Issued'),
...
--
-- Table structure for table `dd_return_history`
--

CREATE TABLE `dd_return_history` (
...
--
-- Table structure for table `dd_return_reason`
--

CREATE TABLE `dd_return_reason` (
  `return_reason_id` int NOT NULL,
  `language_id` int NOT NULL DEFAULT '0',
  `name` varchar(128) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `dd_return_reason`
--

INSERT INTO `dd_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
--
-- Table structure for table `dd_return_status`
--

CREATE TABLE `dd_return_status` (
  `return_status_id` int NOT NULL,
  `language_id` int NOT NULL DEFAULT '0',
  `name` varchar(32) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `dd_return_status`
--

INSERT INTO `dd_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
...
--
-- Table structure for table `dd_review`
--

CREATE TABLE `dd_review` (
...
--
-- Table structure for table `dd_seo_url`
--

CREATE TABLE `dd_seo_url` (
...
--
-- Dumping data for table `dd_seo_url`
--

INSERT INTO `dd_seo_url` (`seo_url_id`, `store_id`, `language_id`, `key`, `value`, `keyword`, `sort_order`) VALUES
...
(76, 0, 1, 'path', '33_59', 'cameras/testtinng', 0);

-- --------------------------------------------------------

--
-- Table structure for table `dd_session`
--
...
--
-- Dumping data for table `dd_session`
--

INSERT INTO `dd_session` (`session_id`, `data`, `expire`) VALUES
('19350259c9e03d175601ea7a55', '{\"user_id\":\"1\",\"user_token\":\"dd8bea98360211d90ef1ba7197046385\"}', '2024-09-14 19:19:58');

-- --------------------------------------------------------

--
-- Table structure for table `dd_setting`
--

CREATE TABLE `dd_setting` (
...
--
-- Dumping data for table `dd_setting`
--

INSERT INTO `dd_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
...
(99, 0, 'config', 'config_email', 'test@email.com', 0),
...
(215, 0, 'config', 'config_encryption', '', 0),
(216, 0, 'config', 'config_api_id', '1', 0);

-- --------------------------------------------------------

--
-- Table structure for table `dd_shape`
--
...
--
-- Table structure for table `dd_startup`
--

CREATE TABLE `dd_startup` (
...
--
-- Table structure for table `dd_statistics`
--

CREATE TABLE `dd_statistics` (
...
--
-- Dumping data for table `dd_statistics`
--

INSERT INTO `dd_statistics` (`statistics_id`, `code`, `value`) VALUES
(1, 'order_sale', '0.0000'),
...
--
-- Table structure for table `dd_stock_status`
--

CREATE TABLE `dd_stock_status` (
  `stock_status_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(32) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `dd_stock_status`
--

INSERT INTO `dd_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(5, 1, 'Out Of Stock'),
(6, 1, '2-3 Days'),
(7, 1, 'In Stock'),
(8, 1, 'Pre-Order');
...
--
-- Table structure for table `dd_store`
--

CREATE TABLE `dd_store` (
  `store_id` int NOT NULL,
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Table structure for table `dd_subscription`
--

CREATE TABLE `dd_subscription` (
  `subscription_id` int NOT NULL,
  `order_id` int NOT NULL,
  `order_product_id` int NOT NULL,
  `store_id` int NOT NULL,
...
--
-- Table structure for table `dd_subscription_history`
--

CREATE TABLE `dd_subscription_history` (
...
--
-- Table structure for table `dd_subscription_plan`
--

CREATE TABLE `dd_subscription_plan` (
  `subscription_plan_id` int NOT NULL,
  `trial_frequency` enum('day','week','semi_month','month','year') COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `dd_subscription_plan`
--

INSERT INTO `dd_subscription_plan` (`subscription_plan_id`, `trial_frequency`, `trial_duration`, `trial_cycle`, `trial_status`, `frequency`, `duration`, `cycle`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `dd_subscription_plan_description`
--

CREATE TABLE `dd_subscription_plan_description` (
  `subscription_plan_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `dd_subscription_plan_description`
--

INSERT INTO `dd_subscription_plan_description` (`subscription_plan_id`, `language_id`, `name`) VALUES
...
--
-- Table structure for table `dd_subscription_status`
--

CREATE TABLE `dd_subscription_status` (
  `subscription_status_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(32) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `dd_subscription_status`
--

INSERT INTO `dd_subscription_status` (`subscription_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(2, 1, 'Active'),
(3, 1, 'Expired'),
(4, 1, 'Suspended'),
...
--
-- Table structure for table `dd_tax_class`
--

CREATE TABLE `dd_tax_class` (
  `tax_class_id` int NOT NULL,
  `title` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `description` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `date_added` datetime NOT NULL,
...
--
-- Dumping data for table `dd_tax_class`
--

INSERT INTO `dd_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `dd_tax_rate`
--

CREATE TABLE `dd_tax_rate` (
...
--
-- Dumping data for table `dd_tax_rate`
--

INSERT INTO `dd_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `dd_tax_rate_to_customer_group`
--

CREATE TABLE `dd_tax_rate_to_customer_group` (
  `tax_rate_id` int NOT NULL,
  `customer_group_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `dd_tax_rate_to_customer_group`
--

INSERT INTO `dd_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Table structure for table `dd_tax_rule`
--

CREATE TABLE `dd_tax_rule` (
...
--
-- Dumping data for table `dd_tax_rule`
--

INSERT INTO `dd_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(120, 10, 87, 'store', 0),
(121, 10, 86, 'payment', 1),
(127, 9, 87, 'shipping', 2),
(128, 9, 86, 'shipping', 1);
...
--
-- Table structure for table `dd_theme`
--

CREATE TABLE `dd_theme` (
...
--
-- Table structure for table `dd_topic`
--
...
--
-- Table structure for table `dd_topic_description`
--

CREATE TABLE `dd_topic_description` (
  `topic_id` int NOT NULL,
  `language_id` int NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Table structure for table `dd_topic_to_store`
--

CREATE TABLE `dd_topic_to_store` (
  `topic_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `dd_translation`
--

CREATE TABLE `dd_translation` (
...
--
-- Table structure for table `dd_upload`
--
...
INSERT INTO `dd_user` (`user_id`, `user_group_id`, `username`, `password`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'admin', '$2y$10$k.HncOZew5t.v0e0HEaaP.RrGVkZGrXD4DXwbbeQ2ASc9x8cN3HJi', 'John', 'Doe', 'test@email.com', '', '', '::1', 1, '2024-09-06 22:06:35');

-- --------------------------------------------------------

--
-- Table structure for table `dd_user_authorize`
--

CREATE TABLE `dd_user_authorize` (
...
INSERT INTO `dd_user_login` (`user_login_id`, `user_id`, `ip`, `user_agent`, `date_added`) VALUES
(1, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '2024-09-06 22:06:55'),
(2, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '2024-09-06 22:11:49'),
(3, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '2024-09-07 09:00:01'),
(4, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '2024-09-08 06:49:54'),
(5, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '2024-09-08 20:43:35'),
(6, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '2024-09-10 16:35:00'),
(7, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '2024-09-10 22:00:00'),
(8, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '2024-09-13 18:53:50');

-- --------------------------------------------------------

--
-- Table structure for table `dd_voucher`
--

CREATE TABLE `dd_voucher` (
  `voucher_id` int NOT NULL,
  `order_id` int NOT NULL,
  `code` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `from_name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Table structure for table `dd_voucher_history`
--

CREATE TABLE `dd_voucher_history` (
...
--
-- Table structure for table `dd_voucher_theme`
--

CREATE TABLE `dd_voucher_theme` (
  `voucher_theme_id` int NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `dd_voucher_theme`
--

INSERT INTO `dd_voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- Table structure for table `dd_voucher_theme_description`
--

CREATE TABLE `dd_voucher_theme_description` (
  `voucher_theme_id` int NOT NULL,
  `language_id` int NOT NULL,
  `name` varchar(32) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `dd_voucher_theme_description`
--

INSERT INTO `dd_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6, 1, 'Christmas'),
(7, 1, 'Birthday'),
(8, 1, 'General');
...
--
-- Table structure for table `dd_weight_class`
--

CREATE TABLE `dd_weight_class` (
  `weight_class_id` int NOT NULL,
  `value` decimal(15,8) NOT NULL DEFAULT '0.00000000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;

--
-- Dumping data for table `dd_weight_class`
--

INSERT INTO `dd_weight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
--
-- Table structure for table `dd_weight_class_description`
--

CREATE TABLE `dd_weight_class_description` (
  `weight_class_id` int NOT NULL,
  `language_id` int NOT NULL,
  `title` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `unit` varchar(4) COLLATE utf8mb4_general_ci NOT NULL
...
--
-- Dumping data for table `dd_weight_class_description`
--

INSERT INTO `dd_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz');
...
--
-- Table structure for table `dd_zone`
--
...
--
-- Dumping data for table `dd_zone`
--

INSERT INTO `dd_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
...
--
-- Table structure for table `dd_zone_to_geo_zone`
--

CREATE TABLE `dd_zone_to_geo_zone` (
...
--
-- Dumping data for table `dd_zone_to_geo_zone`
--

INSERT INTO `dd_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
...
--
-- Indexes for table `dd_address_format`
--
ALTER TABLE `dd_address_format`
  ADD PRIMARY KEY (`address_format_id`);

--
-- Indexes for table `dd_antispam`
--
ALTER TABLE `dd_antispam`
  ADD PRIMARY KEY (`antispam_id`),
  ADD KEY `keyword` (`keyword`);

--
-- Indexes for table `dd_api`
--
ALTER TABLE `dd_api`
  ADD PRIMARY KEY (`api_id`);

--
-- Indexes for table `dd_api_ip`
--
ALTER TABLE `dd_api_ip`
  ADD PRIMARY KEY (`api_ip_id`);

--
-- Indexes for table `dd_api_session`
--
ALTER TABLE `dd_api_session`
  ADD PRIMARY KEY (`api_session_id`);

--
-- Indexes for table `dd_article`
--
ALTER TABLE `dd_article`
  ADD PRIMARY KEY (`article_id`);

--
-- Indexes for table `dd_article_comment`
--
ALTER TABLE `dd_article_comment`
  ADD PRIMARY KEY (`article_comment_id`),
  ADD KEY `article_id` (`article_id`);

--
-- Indexes for table `dd_article_description`
--
ALTER TABLE `dd_article_description`
  ADD PRIMARY KEY (`article_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `dd_article_to_layout`
--
ALTER TABLE `dd_article_to_layout`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Indexes for table `dd_article_to_store`
--
ALTER TABLE `dd_article_to_store`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Indexes for table `dd_assembler`
--
ALTER TABLE `dd_assembler`
  ADD PRIMARY KEY (`assembler_id`);

--
-- Indexes for table `dd_attribute`
--
ALTER TABLE `dd_attribute`
  ADD PRIMARY KEY (`attribute_id`);

--
-- Indexes for table `dd_attribute_description`
--
ALTER TABLE `dd_attribute_description`
  ADD PRIMARY KEY (`attribute_id`,`language_id`);

--
-- Indexes for table `dd_attribute_group`
--
ALTER TABLE `dd_attribute_group`
  ADD PRIMARY KEY (`attribute_group_id`);

--
-- Indexes for table `dd_attribute_group_description`
--
ALTER TABLE `dd_attribute_group_description`
  ADD PRIMARY KEY (`attribute_group_id`,`language_id`);

--
-- Indexes for table `dd_banner`
--
ALTER TABLE `dd_banner`
  ADD PRIMARY KEY (`banner_id`);

--
-- Indexes for table `dd_banner_image`
--
ALTER TABLE `dd_banner_image`
...
--
-- Indexes for table `dd_category_description`
--
ALTER TABLE `dd_category_description`
  ADD PRIMARY KEY (`category_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `dd_category_filter`
--
ALTER TABLE `dd_category_filter`
  ADD PRIMARY KEY (`category_id`,`filter_id`);

--
-- Indexes for table `dd_category_path`
--
ALTER TABLE `dd_category_path`
  ADD PRIMARY KEY (`category_id`,`path_id`);

--
-- Indexes for table `dd_category_to_layout`
--
ALTER TABLE `dd_category_to_layout`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `dd_category_to_store`
--
ALTER TABLE `dd_category_to_store`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `dd_client`
--
ALTER TABLE `dd_client`
  ADD PRIMARY KEY (`client_id`);

--
-- Indexes for table `dd_colour`
--
ALTER TABLE `dd_colour`
  ADD PRIMARY KEY (`colour_id`);

--
-- Indexes for table `dd_country`
--
ALTER TABLE `dd_country`
  ADD PRIMARY KEY (`country_id`);

--
-- Indexes for table `dd_coupon`
--
ALTER TABLE `dd_coupon`
  ADD PRIMARY KEY (`coupon_id`);

--
-- Indexes for table `dd_coupon_category`
--
ALTER TABLE `dd_coupon_category`
  ADD PRIMARY KEY (`coupon_id`,`category_id`);

--
-- Indexes for table `dd_coupon_history`
--
ALTER TABLE `dd_coupon_history`
  ADD PRIMARY KEY (`coupon_history_id`);

--
-- Indexes for table `dd_coupon_product`
--
ALTER TABLE `dd_coupon_product`
  ADD PRIMARY KEY (`coupon_product_id`);

--
-- Indexes for table `dd_cron`
--
ALTER TABLE `dd_cron`
  ADD PRIMARY KEY (`cron_id`);

--
-- Indexes for table `dd_currency`
--
ALTER TABLE `dd_currency`
  ADD PRIMARY KEY (`currency_id`);

--
-- Indexes for table `dd_customer`
--
ALTER TABLE `dd_customer`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indexes for table `dd_customer_activity`
--
ALTER TABLE `dd_customer_activity`
  ADD PRIMARY KEY (`customer_activity_id`);

--
-- Indexes for table `dd_customer_affiliate`
--
ALTER TABLE `dd_customer_affiliate`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indexes for table `dd_customer_affiliate_report`
--
ALTER TABLE `dd_customer_affiliate_report`
  ADD PRIMARY KEY (`customer_affiliate_report_id`);

--
-- Indexes for table `dd_customer_approval`
--
ALTER TABLE `dd_customer_approval`
  ADD PRIMARY KEY (`customer_approval_id`);

--
-- Indexes for table `dd_customer_group`
--
ALTER TABLE `dd_customer_group`
  ADD PRIMARY KEY (`customer_group_id`);

--
-- Indexes for table `dd_customer_group_description`
--
ALTER TABLE `dd_customer_group_description`
  ADD PRIMARY KEY (`customer_group_id`,`language_id`);

--
-- Indexes for table `dd_customer_history`
--
ALTER TABLE `dd_customer_history`
  ADD PRIMARY KEY (`customer_history_id`);

--
-- Indexes for table `dd_customer_ip`
--
ALTER TABLE `dd_customer_ip`
  ADD PRIMARY KEY (`customer_ip_id`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `dd_customer_login`
--
ALTER TABLE `dd_customer_login`
  ADD PRIMARY KEY (`customer_login_id`),
  ADD KEY `email` (`email`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `dd_customer_online`
--
ALTER TABLE `dd_customer_online`
  ADD PRIMARY KEY (`ip`);

--
-- Indexes for table `dd_customer_reward`
--
ALTER TABLE `dd_customer_reward`
  ADD PRIMARY KEY (`customer_reward_id`);

--
-- Indexes for table `dd_customer_search`
--
ALTER TABLE `dd_customer_search`
  ADD PRIMARY KEY (`customer_search_id`);

--
-- Indexes for table `dd_customer_transaction`
--
ALTER TABLE `dd_customer_transaction`
  ADD PRIMARY KEY (`customer_transaction_id`);

--
-- Indexes for table `dd_customer_wishlist`
--
ALTER TABLE `dd_customer_wishlist`
  ADD PRIMARY KEY (`customer_id`,`product_id`);

--
-- Indexes for table `dd_custom_field`
--
ALTER TABLE `dd_custom_field`
  ADD PRIMARY KEY (`custom_field_id`);

--
-- Indexes for table `dd_custom_field_customer_group`
--
ALTER TABLE `dd_custom_field_customer_group`
  ADD PRIMARY KEY (`custom_field_id`,`customer_group_id`);

--
-- Indexes for table `dd_custom_field_description`
--
ALTER TABLE `dd_custom_field_description`
  ADD PRIMARY KEY (`custom_field_id`,`language_id`);

--
-- Indexes for table `dd_custom_field_value`
--
ALTER TABLE `dd_custom_field_value`
  ADD PRIMARY KEY (`custom_field_value_id`);

--
-- Indexes for table `dd_custom_field_value_description`
--
ALTER TABLE `dd_custom_field_value_description`
  ADD PRIMARY KEY (`custom_field_value_id`,`language_id`);

--
-- Indexes for table `dd_download`
--
ALTER TABLE `dd_download`
  ADD PRIMARY KEY (`download_id`);

--
-- Indexes for table `dd_download_description`
--
ALTER TABLE `dd_download_description`
  ADD PRIMARY KEY (`download_id`,`language_id`);

--
-- Indexes for table `dd_download_report`
--
ALTER TABLE `dd_download_report`
  ADD PRIMARY KEY (`download_report_id`);

--
-- Indexes for table `dd_event`
--
ALTER TABLE `dd_event`
  ADD PRIMARY KEY (`event_id`);

--
-- Indexes for table `dd_extension`
--
ALTER TABLE `dd_extension`
  ADD PRIMARY KEY (`extension_id`);

--
-- Indexes for table `dd_extension_install`
--
ALTER TABLE `dd_extension_install`
  ADD PRIMARY KEY (`extension_install_id`);

--
-- Indexes for table `dd_extension_path`
--
ALTER TABLE `dd_extension_path`
  ADD PRIMARY KEY (`extension_path_id`),
  ADD KEY `path` (`path`);

--
-- Indexes for table `dd_filter`
--
ALTER TABLE `dd_filter`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `dd_filter_description`
--
ALTER TABLE `dd_filter_description`
  ADD PRIMARY KEY (`filter_id`,`language_id`);

--
-- Indexes for table `dd_filter_group`
--
ALTER TABLE `dd_filter_group`
  ADD PRIMARY KEY (`filter_group_id`);

--
-- Indexes for table `dd_filter_group_description`
--
ALTER TABLE `dd_filter_group_description`
  ADD PRIMARY KEY (`filter_group_id`,`language_id`);

--
-- Indexes for table `dd_gdpr`
--
ALTER TABLE `dd_gdpr`
  ADD PRIMARY KEY (`gdpr_id`);

--
-- Indexes for table `dd_geo_zone`
--
ALTER TABLE `dd_geo_zone`
  ADD PRIMARY KEY (`geo_zone_id`);

--
-- Indexes for table `dd_information`
--
ALTER TABLE `dd_information`
  ADD PRIMARY KEY (`information_id`);

--
-- Indexes for table `dd_information_description`
--
ALTER TABLE `dd_information_description`
  ADD PRIMARY KEY (`information_id`,`language_id`);

--
-- Indexes for table `dd_information_to_layout`
--
ALTER TABLE `dd_information_to_layout`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indexes for table `dd_information_to_store`
--
ALTER TABLE `dd_information_to_store`
  ADD PRIMARY KEY (`information_id`,`store_id`);
...
--
-- Indexes for table `dd_layout`
--
ALTER TABLE `dd_layout`
  ADD PRIMARY KEY (`layout_id`);

--
-- Indexes for table `dd_layout_module`
--
ALTER TABLE `dd_layout_module`
  ADD PRIMARY KEY (`layout_module_id`);

--
-- Indexes for table `dd_layout_route`
--
ALTER TABLE `dd_layout_route`
  ADD PRIMARY KEY (`layout_route_id`);

--
-- Indexes for table `dd_length_class`
--
ALTER TABLE `dd_length_class`
  ADD PRIMARY KEY (`length_class_id`);

--
-- Indexes for table `dd_length_class_description`
--
ALTER TABLE `dd_length_class_description`
  ADD PRIMARY KEY (`length_class_id`,`language_id`);

--
-- Indexes for table `dd_location`
--
ALTER TABLE `dd_location`
  ADD PRIMARY KEY (`location_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `dd_manufacturer`
--
ALTER TABLE `dd_manufacturer`
  ADD PRIMARY KEY (`manufacturer_id`);

--
-- Indexes for table `dd_manufacturer_to_layout`
--
ALTER TABLE `dd_manufacturer_to_layout`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Indexes for table `dd_manufacturer_to_store`
--
ALTER TABLE `dd_manufacturer_to_store`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Indexes for table `dd_marketing`
--
ALTER TABLE `dd_marketing`
  ADD PRIMARY KEY (`marketing_id`);

--
-- Indexes for table `dd_marketing_report`
--
ALTER TABLE `dd_marketing_report`
  ADD PRIMARY KEY (`marketing_report_id`);

--
-- Indexes for table `dd_module`
--
ALTER TABLE `dd_module`
  ADD PRIMARY KEY (`module_id`);

--
-- Indexes for table `dd_notification`
--
ALTER TABLE `dd_notification`
  ADD PRIMARY KEY (`notification_id`);

--
-- Indexes for table `dd_option`
--
ALTER TABLE `dd_option`
  ADD PRIMARY KEY (`option_id`);

--
-- Indexes for table `dd_option_description`
--
ALTER TABLE `dd_option_description`
  ADD PRIMARY KEY (`option_id`,`language_id`);

--
-- Indexes for table `dd_option_value`
--
ALTER TABLE `dd_option_value`
  ADD PRIMARY KEY (`option_value_id`);

--
-- Indexes for table `dd_option_value_description`
--
ALTER TABLE `dd_option_value_description`
...
--
-- Indexes for table `dd_orders`
--
ALTER TABLE `dd_orders`
  ADD PRIMARY KEY (`orders_id`);

--
-- Indexes for table `dd_order_history`
--
ALTER TABLE `dd_order_history`
  ADD PRIMARY KEY (`order_history_id`);

--
-- Indexes for table `dd_order_option`
--
ALTER TABLE `dd_order_option`
  ADD PRIMARY KEY (`order_option_id`);

--
-- Indexes for table `dd_order_product`
--
ALTER TABLE `dd_order_product`
  ADD PRIMARY KEY (`order_product_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `dd_order_status`
--
ALTER TABLE `dd_order_status`
  ADD PRIMARY KEY (`order_status_id`,`language_id`);

--
-- Indexes for table `dd_order_subscription`
--
ALTER TABLE `dd_order_subscription`
  ADD PRIMARY KEY (`order_subscription_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `dd_order_total`
--
ALTER TABLE `dd_order_total`
  ADD PRIMARY KEY (`order_total_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `dd_order_voucher`
--
ALTER TABLE `dd_order_voucher`
  ADD PRIMARY KEY (`order_voucher_id`);

--
-- Indexes for table `dd_powder`
--
ALTER TABLE `dd_powder`
  ADD PRIMARY KEY (`powder_id`);
...
--
-- Indexes for table `dd_product_1`
--
ALTER TABLE `dd_product_1`
  ADD PRIMARY KEY (`product_id`);

--
-- Indexes for table `dd_product_attribute`
--
ALTER TABLE `dd_product_attribute`
  ADD PRIMARY KEY (`product_id`,`attribute_id`,`language_id`);

--
-- Indexes for table `dd_product_description`
--
ALTER TABLE `dd_product_description`
  ADD PRIMARY KEY (`product_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `dd_product_discount`
--
ALTER TABLE `dd_product_discount`
  ADD PRIMARY KEY (`product_discount_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `dd_product_filter`
--
ALTER TABLE `dd_product_filter`
  ADD PRIMARY KEY (`product_id`,`filter_id`);

--
-- Indexes for table `dd_product_image`
--
ALTER TABLE `dd_product_image`
  ADD PRIMARY KEY (`product_image_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `dd_product_option`
--
ALTER TABLE `dd_product_option`
  ADD PRIMARY KEY (`product_option_id`);

--
-- Indexes for table `dd_product_option_value`
--
ALTER TABLE `dd_product_option_value`
  ADD PRIMARY KEY (`product_option_value_id`);

--
-- Indexes for table `dd_product_related`
--
ALTER TABLE `dd_product_related`
  ADD PRIMARY KEY (`product_id`,`related_id`);

--
-- Indexes for table `dd_product_report`
--
ALTER TABLE `dd_product_report`
  ADD PRIMARY KEY (`product_report_id`);

--
-- Indexes for table `dd_product_reward`
--
ALTER TABLE `dd_product_reward`
  ADD PRIMARY KEY (`product_reward_id`);

--
-- Indexes for table `dd_product_special`
--
ALTER TABLE `dd_product_special`
  ADD PRIMARY KEY (`product_special_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `dd_product_subscription`
--
ALTER TABLE `dd_product_subscription`
  ADD PRIMARY KEY (`product_id`,`subscription_plan_id`,`customer_group_id`);

--
-- Indexes for table `dd_product_to_category`
--
ALTER TABLE `dd_product_to_category`
  ADD PRIMARY KEY (`product_id`,`category_id`),
  ADD KEY `category_id` (`category_id`);

--
-- Indexes for table `dd_product_to_download`
--
ALTER TABLE `dd_product_to_download`
  ADD PRIMARY KEY (`product_id`,`download_id`);

--
-- Indexes for table `dd_product_to_layout`
--
ALTER TABLE `dd_product_to_layout`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `dd_product_to_store`
--
ALTER TABLE `dd_product_to_store`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `dd_product_viewed`
--
ALTER TABLE `dd_product_viewed`
  ADD PRIMARY KEY (`product_id`);

--
-- Indexes for table `dd_return`
--
ALTER TABLE `dd_return`
  ADD PRIMARY KEY (`return_id`);

--
-- Indexes for table `dd_return_action`
--
ALTER TABLE `dd_return_action`
  ADD PRIMARY KEY (`return_action_id`,`language_id`);

--
-- Indexes for table `dd_return_history`
--
ALTER TABLE `dd_return_history`
  ADD PRIMARY KEY (`return_history_id`);

--
-- Indexes for table `dd_return_reason`
--
ALTER TABLE `dd_return_reason`
  ADD PRIMARY KEY (`return_reason_id`,`language_id`);

--
-- Indexes for table `dd_return_status`
--
ALTER TABLE `dd_return_status`
  ADD PRIMARY KEY (`return_status_id`,`language_id`);

--
-- Indexes for table `dd_review`
--
ALTER TABLE `dd_review`
  ADD PRIMARY KEY (`review_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `dd_seo_url`
--
ALTER TABLE `dd_seo_url`
  ADD PRIMARY KEY (`seo_url_id`),
  ADD KEY `keyword` (`keyword`),
  ADD KEY `query` (`key`,`value`);

--
-- Indexes for table `dd_session`
--
...
--
-- Indexes for table `dd_setting`
--
ALTER TABLE `dd_setting`
  ADD PRIMARY KEY (`setting_id`);

--
-- Indexes for table `dd_shape`
--
ALTER TABLE `dd_shape`
  ADD PRIMARY KEY (`shape_id`);

--
-- Indexes for table `dd_startup`
--
ALTER TABLE `dd_startup`
  ADD PRIMARY KEY (`startup_id`);

--
-- Indexes for table `dd_statistics`
--
ALTER TABLE `dd_statistics`
  ADD PRIMARY KEY (`statistics_id`);

--
-- Indexes for table `dd_stock_status`
--
ALTER TABLE `dd_stock_status`
  ADD PRIMARY KEY (`stock_status_id`,`language_id`);

--
-- Indexes for table `dd_store`
--
ALTER TABLE `dd_store`
  ADD PRIMARY KEY (`store_id`);

--
-- Indexes for table `dd_subscription`
--
ALTER TABLE `dd_subscription`
  ADD PRIMARY KEY (`subscription_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `dd_subscription_history`
--
ALTER TABLE `dd_subscription_history`
  ADD PRIMARY KEY (`subscription_history_id`);

--
-- Indexes for table `dd_subscription_plan`
--
ALTER TABLE `dd_subscription_plan`
  ADD PRIMARY KEY (`subscription_plan_id`);

--
-- Indexes for table `dd_subscription_plan_description`
--
ALTER TABLE `dd_subscription_plan_description`
  ADD PRIMARY KEY (`subscription_plan_id`,`language_id`);

--
-- Indexes for table `dd_subscription_status`
--
ALTER TABLE `dd_subscription_status`
  ADD PRIMARY KEY (`subscription_status_id`,`language_id`);

--
-- Indexes for table `dd_tax_class`
--
ALTER TABLE `dd_tax_class`
  ADD PRIMARY KEY (`tax_class_id`);

--
-- Indexes for table `dd_tax_rate`
--
ALTER TABLE `dd_tax_rate`
  ADD PRIMARY KEY (`tax_rate_id`);

--
-- Indexes for table `dd_tax_rate_to_customer_group`
--
ALTER TABLE `dd_tax_rate_to_customer_group`
  ADD PRIMARY KEY (`tax_rate_id`,`customer_group_id`);

--
-- Indexes for table `dd_tax_rule`
--
ALTER TABLE `dd_tax_rule`
  ADD PRIMARY KEY (`tax_rule_id`);

--
-- Indexes for table `dd_theme`
--
ALTER TABLE `dd_theme`
  ADD PRIMARY KEY (`theme_id`);

--
-- Indexes for table `dd_topic`
--
ALTER TABLE `dd_topic`
  ADD PRIMARY KEY (`topic_id`);

--
-- Indexes for table `dd_topic_description`
--
ALTER TABLE `dd_topic_description`
  ADD PRIMARY KEY (`topic_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `dd_topic_to_store`
--
ALTER TABLE `dd_topic_to_store`
  ADD PRIMARY KEY (`topic_id`,`store_id`);

--
-- Indexes for table `dd_translation`
--
ALTER TABLE `dd_translation`
  ADD PRIMARY KEY (`translation_id`);

--
-- Indexes for table `dd_upload`
--
ALTER TABLE `dd_upload`
...
--
-- Indexes for table `dd_user_authorize`
--
ALTER TABLE `dd_user_authorize`
...
--
-- Indexes for table `dd_user_login`
--
ALTER TABLE `dd_user_login`
  ADD PRIMARY KEY (`user_login_id`);

--
-- Indexes for table `dd_voucher`
--
ALTER TABLE `dd_voucher`
  ADD PRIMARY KEY (`voucher_id`);

--
-- Indexes for table `dd_voucher_history`
--
ALTER TABLE `dd_voucher_history`
  ADD PRIMARY KEY (`voucher_history_id`);

--
-- Indexes for table `dd_voucher_theme`
--
ALTER TABLE `dd_voucher_theme`
  ADD PRIMARY KEY (`voucher_theme_id`);

--
-- Indexes for table `dd_voucher_theme_description`
--
ALTER TABLE `dd_voucher_theme_description`
  ADD PRIMARY KEY (`voucher_theme_id`,`language_id`);

--
-- Indexes for table `dd_weight_class`
--
ALTER TABLE `dd_weight_class`
  ADD PRIMARY KEY (`weight_class_id`);

--
-- Indexes for table `dd_weight_class_description`
--
ALTER TABLE `dd_weight_class_description`
  ADD PRIMARY KEY (`weight_class_id`,`language_id`);

--
-- Indexes for table `dd_zone`
--
ALTER TABLE `dd_zone`
  ADD PRIMARY KEY (`zone_id`);

--
-- Indexes for table `dd_zone_to_geo_zone`
--
ALTER TABLE `dd_zone_to_geo_zone`
...
--
-- AUTO_INCREMENT for table `dd_user_authorize`
--
ALTER TABLE `dd_user_authorize`
...
--
-- AUTO_INCREMENT for table `dd_user_login`
--
ALTER TABLE `dd_user_login`
  MODIFY `user_login_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `dd_voucher`
--
ALTER TABLE `dd_voucher`
  MODIFY `voucher_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `dd_voucher_history`
--
ALTER TABLE `dd_voucher_history`
  MODIFY `voucher_history_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `dd_voucher_theme`
--
ALTER TABLE `dd_voucher_theme`
  MODIFY `voucher_theme_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `dd_weight_class`
--
ALTER TABLE `dd_weight_class`
  MODIFY `weight_class_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `dd_zone`
--
ALTER TABLE `dd_zone`
  MODIFY `zone_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4442;

--
-- AUTO_INCREMENT for table `dd_zone_to_geo_zone`
--
ALTER TABLE `dd_zone_to_geo_zone`
