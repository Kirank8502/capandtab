...
class Product extends \Opencart\System\Engine\Model {
	public function addProduct($data) {
      	$this->db->query("INSERT INTO " . DB_PREFIX . "product SET `name` = '" . $this->db->escape($data['product_name']) . "',status = '" . (int)$data['product_status']."'");
	...
	public function editProduct($product_id, $data) {
      	$this->db->query("UPDATE " . DB_PREFIX . "product SET `name` = '" . $this->db->escape($data['product_name']) . "', status = '" . (int)$data['product_status'] ."' WHERE product_id= '" . (int)$product_id. "'");
