...
class ColumnLeft extends \Opencart\System\Engine\Controller {
	...
	public function index(): string {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ((string)$this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/order')) {
				$catalog[] = [
					'name'	   => $this->language->get('text_order'),
					'href'     => $this->url->link('catalog/order', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}
			...
			if ($this->user->hasPermission('access', 'catalog/sale')) {
				$catalog[] = [
					'name'	   => 'Sale',
					'href'     => $this->url->link('catalog/sale', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}
			...
			if ($this->user->hasPermission('access', 'masters/assembler')) {
				$masters[] = [
					'name'	   => 'Assembler',
			...
			if ($this->user->hasPermission('access', 'masters/client')) {
				$masters[] = [
					'name'	   => 'Client',
					'href'     => $this->url->link('masters/client', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}

			if ($this->user->hasPermission('access', 'masters/powder')) {
				$masters[] = [
					'name'	   => 'Powder',
					'href'     => $this->url->link('masters/powder', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}
			...
			if ($this->user->hasPermission('access', 'masters/colour')) {
				$masters[] = [
					'name'	   => 'Colour',
					'href'     => $this->url->link('masters/colour', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}
