...
/* erpadmin/view/template/catalog/order.twig */
class __TwigTemplate_d61183aacb9a80b33d0571fa96bbc581 extends Template
{
    private $source;
    private $macros = [];
...
\$('#button-filter').on('click', function () {
    ...
    window.history.pushState({}, null, 'index.php?route=catalog/order&user_token=";
        // line 50
        echo ($context["user_token"] ?? null);
        echo "' + url);

    \$('#order').load('index.php?route=catalog/order|list&user_token=";
        // line 52
        echo ($context["user_token"] ?? null);
        echo "' + url);
});
...
\$('#input-name').autocomplete({
    'source': function (request, response) {
        \$.ajax({
            url: 'index.php?route=catalog/order|autocomplete&user_token=";
        // line 58
        echo ($context["user_token"] ?? null);
...
";
    ...
    {
        return "erpadmin/view/template/catalog/order.twig";
    }
    ...
    {
        return new Source("", "erpadmin/view/template/catalog/order.twig", "C:\\laragon\\www\\jewellery\\erpadmin\\view\\template\\catalog\\order.twig");
    }
}
